...
def main():
    ...
    writer = tb.SummaryWriter('./runs/{}'.format(args.dataset))
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if val_loss < best_loss:
            ...
            torch.save(model.state_dict(), f'./checkpoint/{args.dataset}/model_state_dict.pt')
    ...
    for score, metrics_name in zip(scores, utils.metrics.keys()):
